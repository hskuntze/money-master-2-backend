...
public record SavingsJarCreateRequest(
        @NotBlank(message = "O nome do cofrinho é obrigatório.")
        ...
        @DecimalMin(value = "0.00", message = "O valor atual deve ser maior ou igual a zero.")
