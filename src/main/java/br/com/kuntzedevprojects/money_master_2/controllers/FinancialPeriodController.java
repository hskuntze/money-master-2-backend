...
public class FinancialPeriodController {
	...
	public ResponseEntity<FinancialPeriodResponse> turnover(@Valid @RequestBody FinancialPeriodTurnoverRequest request,
			Principal principal) {
		return ResponseEntity.status(HttpStatus.CREATED)
				.body(financialPeriodService.turnover(principal.getName(), request));
	}

	@PutMapping("/{id}")
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<FinancialPeriodResponse> updatePeriod(@PathVariable Long id,
			@Valid @RequestBody FinancialPeriodUpdateRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_READ')")
	public ResponseEntity<List<MonthlyPlanItemResponse>> listPlanItems(@PathVariable Long periodId,
			@RequestParam(required = false) MonthlyPlanItemStatus status, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> createPlanItem(@PathVariable Long periodId,
			@Valid @RequestBody MonthlyPlanItemCreateRequest request, Principal principal) {
		return ResponseEntity.status(HttpStatus.CREATED)
				.body(financialPeriodService.createPlanItem(principal.getName(), periodId, request));
	}

	@PutMapping("/plan-items/{itemId}")
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> updatePlanItem(@PathVariable Long itemId,
			@Valid @RequestBody MonthlyPlanItemUpdateRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_READ')")
	public ResponseEntity<List<MonthlyPlanItemResponse>> listInvoiceChildCandidates(@PathVariable Long invoiceItemId,
			Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> linkPlanItemToInvoice(@PathVariable Long invoiceItemId,
			@PathVariable Long childItemId, @RequestBody(required = false) MonthlyPlanItemInvoiceLinkRequest request,
			Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> unlinkPlanItemFromInvoice(@PathVariable Long childItemId,
			Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> registerPayment(@PathVariable Long itemId,
			@Valid @RequestBody(required = false) MonthlyPlanItemPaymentRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> reopenPlanItem(@PathVariable Long itemId,
			@Valid @RequestBody(required = false) MonthlyPlanItemReopenRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> unlinkTransaction(@PathVariable Long itemId,
			@Valid @RequestBody MonthlyPlanItemUnlinkTransactionRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanItemResponse> linkTransaction(@PathVariable Long itemId,
			@Valid @RequestBody MonthlyPlanItemLinkTransactionRequest request, Principal principal) {
	...
	@PreAuthorize("hasAuthority('FINANCE_READ')")
	public ResponseEntity<List<FinancialTransactionResponse>> listUnlinkedTransactions(@PathVariable Long periodId,
			@RequestParam(required = false) TransactionType type,
			@RequestParam(defaultValue = "true") boolean onlyUnlinked, Principal principal) {
		return ResponseEntity.ok(reconciliationService.listTransactionsForAssociation(principal.getName(), periodId,
				type, onlyUnlinked));
	}

	@PostMapping("/{periodId}/reconcile-transactions")
	@PreAuthorize("hasAuthority('FINANCE_MANAGE')")
	public ResponseEntity<MonthlyPlanReconcileResponse> reconcileTransactions(@PathVariable Long periodId,
			@RequestBody(required = false) MonthlyPlanReconcileRequest request, Principal principal) {
